text = 'Mechanical advantage is a measure of the force amplification achieved by using a tool, mechanical device' \
       ...
       ' transmits power without adding to or subtracting from it. This means the ideal mechanism does not' \
       ' include a power source, is frictionless, and is constructed from rigid bodies that do not deflect or wear.' \
